...
- **Tahmin** — Çalıştır'a basmadan önce ne olacağını seçersin: bölümü geçer mi, çalışır ama geçemez mi, hata verir mi, hiç biter mi? Sonra gerçek sonucu görürsün. Zorunlu değil, ama kodu okumadan tahmin edemezsin ve öğrenmenin büyük kısmı orada olur. Seçenekler bölüm bölüm yazılmadı; motorun sonucundan çıkıyor, dolayısıyla serbest modda da çalışır.
- **Bitiş** — Otuz iki bölümü bitiren kişiye ne öğrendiği dört fikirde toparlanır ve bundan sonra nereye gidebileceği söylenir.
- **Kademeli arayüz** — Ekran da dil gibi açılır. Birinci bölümde yapılacak tek bir şey vardır: bir komuta bas, Çalıştır'a bas. Adım adım ve hız üçüncü bölümde, satır hedefi ve Türkçe okuma yedincide, tahmin şeridi on birincide gelir. Her öğe geldiğinde neden geldiği bir cümleyle söylenir.
- **Giriş seviyesi** — Karşılamanın sonunda üç yol var: hiç kod yazmadım, komut ve sıra biliyorum, döngü ve koşul biliyorum. Kod bilen biri baştan başlamak zorunda kalmaz; seçtiği yere kadar bütün bölümler açılır, geri dönmek serbesttir.
